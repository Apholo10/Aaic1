...
const es = {
  ...
  quees: {
    ...
    p1: "Auto Accident Injury Care está aquí para las víctimas de accidentes en Springdale, Arkansas y comunidades cercanas. Respaldados por más de 50 años de experiencia combinada en el tratamiento de lesiones personales, nuestro equipo está listo para ayudarte en tu camino hacia la recuperación.",
