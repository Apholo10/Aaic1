        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="#" aria-label="Instagram" className="w-8 h-8 bg-white/5 hover:bg-[#c22121]/20 border border-white/10 hover:border-[#c22121]/30 rounded-lg flex items-center justify-center transition-all duration-200">
              ...
              <a href="#" aria-label="Google" className="w-8 h-8 bg-white/5 hover:bg-[#c22121]/20 border border-white/10 hover:border-[#c22121]/30 rounded-lg flex items-center justify-center transition-all duration-200">
