        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.facebook.com/profile.php?id=61569130198500" aria-label="Facebook" className="w-8 h-8 bg-white/5 hover:bg-[#c22121]/20 border border-white/10 hover:border-[#c22121]/30 rounded-lg flex items-center justify-center transition-all duration-200">
                <svg className="w-4 h-4 text-white/50" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/autoaccidentinjurycare?igsh=MXZnOThidm84OWZ6ag==" aria-label="Instagram" className="w-8 h-8 bg-white/5 hover:bg-[#c22121]/20 border border-white/10 hover:border-[#c22121]/30 rounded-lg flex items-center justify-center transition-all duration-200">
                <svg className="w-4 h-4 text-white/50" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://share.google/oHuod9HZKV6PZXRMv" aria-label="Google" className="w-8 h-8 bg-white/5 hover:bg-[#c22121]/20 border border-white/10 hover:border-[#c22121]/30 rounded-lg flex items-center justify-center transition-all duration-200">
